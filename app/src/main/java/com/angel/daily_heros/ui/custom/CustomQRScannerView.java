...
public abstract class CustomQRScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    public CustomQRScannerView(Context context, AttributeSet attributeSet) {
